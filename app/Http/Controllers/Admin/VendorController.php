...
class VendorController extends Controller
{
     ...
     public function index()
    {
        ...
        return view('backend.vendor.index', compact('users'));
    }
    ...
    public function view($id)
    {
        ...
        $users = Vendor::where('id',$id)->first();

        return view('backend.vendor.view', compact('users'));
    }
