...
<body style="background-color:#c1e6eb;">
    <div class="account-pages my-5 pt-sm-5">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card overflow-hidden">
                        <div class="bg-primary bg-soft" style="background-color:#005a7a !important">
                            <div class="row">
                                <div class="col-7">
                                    <div class="auth-logo" style="text-align:center; margin-top:44px;">
                                        <a href="#" class="auth-logo-light">
                                            <div class="">
                                                <span class="">
                                                    <img src="{{ asset('/') }}{{ $logo }}" alt=""  height="24">
                                                </span>
                                            </div>
                                        </a>
