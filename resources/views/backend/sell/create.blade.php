...
<form method="POST" action="{{ route('admin.sell_information.store') }}">
    @csrf
<div class="row">
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <select class="select2 form-control show_all_addresss" name="client_slug"
                                ...
                                <option value="{{ $all_client_print->customer_display_name }}">{{ $all_client_print->customer_display_name }}</option>
                                @endforeach
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-9">
                        <select class="form-select" name="ware_house">
                            ...
                            <option>{{ $all_warehouse_list->name }}</option>
                        @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table align-middle table-nowrap table-check" id="dynamicAddRemove">
                        ...
                        <tr>
                            ...
                            <td><input type="number" min="0" class="form-control unit_tax" value="0" name="unit_tax[]" id="unit_tax0" placeholder="Unit Tax" readonly></td>
                            <td><input type="text" class="form-control" id="after_tax0" name="after_tax[]" placeholder="After Tax" readonly></td>
                            <td><input type="text" class="form-control" id="gafter_tax0" name="gafter_tax[]" placeholder="Grand Total" readonly></td>
                            <td>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="mb-2 row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="text" name="total_net_price_tax" value="" id="total_net_price_tax" readonly>
                            </div>
                        </div>
                        ...
                        <div class="mb-2 row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="number" name="total_dis" value="0" id="total_dis">
                            </div>
                        </div>
