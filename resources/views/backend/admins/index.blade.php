                                ...
                                <tr>
                                   <td>
                                    ...
                                    <td>
                                        ...
                                        <a type="button" href="{{ route('admin.admins.view',$user->id) }}"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="custom-validation" action="{{ route('admin.admins.store') }}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group col-md-3 col-sm-12">
                    <label for="email">Position</label>
                    <input type="text" class="form-control form-control-sm" id="email" name="position" placeholder="Enter Position">
                </div>
