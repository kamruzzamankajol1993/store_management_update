...
<form method="POST" action="{{ route('admin.inventory_information.update') }}">
    @csrf

    <input class="hidden" type="hidden" value="{{ $invoice->id }}"  name="id" value="" id="">
<div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-9">
                        <div class="input-group" id="datepicker2">
                            <input type="text" name="request_date" value="{{ $invoice->request_date }}" class="form-control" placeholder="dd M, yyyy"
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-9">
                        <select class=" form-control main_product_id " name="vendor_id" id="main_product_id0" >
                            ...
                            <option value="{{ $main_product_list_all_print->name }}"  {{ $invoice->vendor_id == $main_product_list_all_print->name ? 'selected':'' }}>{{ $main_product_list_all_print->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-9">
                        <select class=" form-control main_product_id " name="request_number" id="main_product_id0" >
                            ...
                            <option value="{{ $main_product_list_all_print->customer_display_name }}"
                                {{ $invoice->request_number == $main_product_list_all_print->customer_display_name ? 'selected':'' }}>{{ $main_product_list_all_print->customer_display_name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-9">
                        <input class="form-control" type="text" value="{{ $invoice->total_quantity }}"  name="total_quantity" value="" id="">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-9">
                        <input class="form-control" type="text" value="{{ $invoice->total_product }}"  name="total_product" value="" id="">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-9">
                        <select class=" form-control main_product_id " name="request_note" id="main_product_id0" >
                            ...
                            <option value="{{ $main_product_list_all_print->name }}" {{ $invoice->request_note == $main_product_list_all_print->name ? 'selected':'' }}>{{ $main_product_list_all_print->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-9">
                        <div class="input-group" id="datepicker2">
                            <input type="text" name="request_delivery_date" value="{{ $invoice->request_delivery_date }}"  class="form-control" placeholder="dd M, yyyy"
                                   data-date-format="dd M, yyyy" data-date-container='#datepicker2'
                                   data-provide="datepicker" data-date-autoclose="true">
