...
@section('title')
Purchase Product Detail | {{ $ins_name }}
@endsection
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Purchase Product Generate</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    {{-- <li class="breadcrumb-item"><a href="javascript: void(0);">{{ $ins_name }} </a></li> --}}
                    <li class="breadcrumb-item active">Purchase Product Page</li>
                </ol>
            </div>
            ...
            <div class="card-body">
                <div class="button-items justify-content-center">
                        ...
                        <button type="button" class="btn btn-primary waves-effect waves-light"
                                onclick='window.location="{{route('admin.purchase_information.edit',$invoice->id)}}"'>
                            <i
                            ...
                            <a type="button" href="{{route('admin.purchase_information.print',$invoice->id)}}" class="btn btn-info waves-effect waves-light"><i
                                class="fas fa-print"
                                ></i>
                            Print
                            </a>
                        ...
                        <div class="col-lg-6">
                            <div class="card-body">
                                ...
                                <h3>
                                    ...
                                    $request_product_list = DB::table('vendors')->where('customer_display_name',$invoice->vendor_id)->first();
