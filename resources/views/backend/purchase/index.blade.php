...
<a class="btn btn-primary dropdown-toggle waves-effect  btn-sm waves-light" href="{{ route('admin.inventory_information.create') }}" type="button">
...
Inactive
                                    ...
                                    <td>
                                      ...
                                      @if (Auth::guard('admin')->user()->can('inventory_update'))
                                          <a type="button" href="{{ route('admin.inventory_information.edit',$user->id) }}" class="btn btn-primary waves-light waves-effect  btn-sm" >
                                          <i class="fas fa-pencil-alt"></i></a>
@endif

{{-- @if (Auth::guard('admin')->user()->can('inventory_view'))
<a type="button" href="{{ route('admin.inventory_information.view',$user->id) }}" class="btn btn-success waves-light waves-effect  btn-sm" >
...
<button   type="button" class="btn btn-danger waves-light waves-effect  btn-sm" onclick="deleteTag({{ $user->id}})" data-toggle="tooltip" title="Delete"><i class="fas fa-trash-alt"></i></button>
                    <form id="delete-form-{{ $user->id }}" action="{{ route('admin.inventory_information.delete',$user->id) }}" method="POST" style="display: none;">
